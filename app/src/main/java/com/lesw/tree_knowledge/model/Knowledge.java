...
import com.lesw.tree_knowledge.dao.DummyDB;
import com.lesw.tree_knowledge.view.IconTreeItem;
import com.lesw.tree_knowledge.R;
import com.lesw.tree_knowledge.dao.RoomDbManager;
import com.lesw.tree_knowledge.view.TreeHolder;
...
public class Knowledge {
    ...
    public static TreeNode generateHRTree(Knowledge knowledge, Context context){
    ...
    public static TreeNode generateManagerTree(Knowledge knowledge, Context context){
        TreeNode root = new TreeNode(new IconTreeItem(R.string.fa_leaf, ColorEnum.GREEN, knowledge)).setViewHolder(new TreeHolder(context));
        for (Knowledge child : knowledge.getChildren()) {
    ...
    public static TreeNode generateUserTree(Employee employee, Context context){
